...
def separar_hexagons_valids(malla):
    """
    Separa els hexàgons vàlids i no vàlids segons la presència
    o absència dels indicadors d'especialització.

    Un hexagon és considerat vàlid quan disposa d'un valor del
    camp 'classe_bivariant'.
    ...
    -------
    tuple:
        QgsVectorLayer: capa vectorial amb els hexàgons vàlids
        QgsVectorLayer: capa vectorial amb els hexàgons no vàlids
    """
