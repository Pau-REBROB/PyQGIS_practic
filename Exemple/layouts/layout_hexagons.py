"""
Composició de les especialitzacions funcionals per malla hexagonal
==================================================================
...
def composicio_bivariant_hexagons(districtes, capes, capa_extent):
    """
    ...
    cfg_layout = config.LAYOUTS["HEXAGONS"]
    cfg_estructura = config.LAYOUTS["ESTRUCTURA_HEXAGONS"]
