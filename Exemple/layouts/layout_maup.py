...
def composicio_maup_densitat_superficie_industrial(capes, capa_terme, capa_extent):
    """
    """

    cfg_layout = config.LAYOUTS["MAUP_SUPERFICIE"]
    cfg_estructura = config.LAYOUTS["ESTRUCTURA_MAUP_SUPERFICIE"]
    ...
    layout = layout_common.generar_layout(
        nom_layout="Densitat superfície industrial de Barcelona",
...
def composicio_maup_densitat_edificis_industrials(capes, capa_terme, capa_extent):
    """
    """

    cfg_layout = config.LAYOUTS["MAUP_EDIFICIS"]
    cfg_estructura = config.LAYOUTS["ESTRUCTURA_MAUP_EDIFICIS"]
